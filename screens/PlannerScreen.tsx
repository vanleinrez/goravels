...
const PlannerScreen: React.FC<PlannerProps> = ({ myTrips }) => {
  ...
  return (
    <div className="h-full bg-stone-50 flex flex-col relative">
      ...
      {/* --- GORA ESSENTIALS DASHBOARD --- */}
      <div className="bg-white p-4 pb-2 border-b border-stone-200 shadow-sm z-10">
          <h1 className="text-lg font-bold text-stone-800 mb-3 flex items-center">
          ...
          <div className="grid grid-cols-3 gap-3 mb-2">
              ...
              >
                  <div className="w-8 h-8 mb-2 bg-orange-100 rounded-full flex items-center justify-center text-orange-600">
                  ...
                  <span className="text-[10px] text-orange-600/70 mt-0.5">Trip Checklist</span>
              </div>
              ...
              >
                  ...
                  <span className="text-[10px] text-blue-600/70 mt-0.5">Achievements</span>
              </div>
              ...
              >
                   <div className="w-8 h-8 mb-2 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600">
                  ...
                  <span className="text-[10px] text-emerald-600/70 mt-0.5">Pay It Forward</span>
              </div>
          </div>
      </div>
      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          <div className={`${showChannelList ? 'w-64 absolute inset-y-0 left-0 z-20' : 'w-0 hidden md:w-64 md:flex'} bg-stone-900 text-stone-300 flex-col transition-all duration-300 flex-shrink-0 md:relative`}>
              <div className="p-4 border-b border-stone-800 flex justify-between items-center">
                  <h2 className="font-bold text-white">Trip Channels</h2>
                  <button onClick={() => setShowChannelList(false)} className="md:hidden"><Icon className="w-5 h-5"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></Icon></button>
              </div>
          ...
          <div className="flex-1 flex flex-col bg-white relative">
               ...
               <div className="h-14 border-b border-stone-200 flex items-center justify-between px-4 bg-white shadow-sm shrink-0">
                   <div className="flex items-center">
                       <button onClick={() => setShowChannelList(true)} className="mr-3 md:hidden text-stone-500">
